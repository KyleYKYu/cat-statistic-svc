      ...
      .on('end', async () => {
        try {
          ...
          for (const stat of stats) {
            const {
              HOSP_CODE, NORMALCOUNT, PRIORITYCOUNT, CATNORMALCOUNT, CATPRIORITYCOUNT, CHEST_PAIN_CASE_WITH_ECG_AVAILABLE,
            ...
            switch (METRICS) {
              ...
              case 'MEMO_CREATE_DETAILS':
                await statModel.addStat(getCluster(HOSP_CODE), HOSP_CODE, METRICS, "NORMAL", NORMALCOUNT, null, null, null, YEAR, MONTH);
                await statModel.addStat(getCluster(HOSP_CODE), HOSP_CODE, METRICS, "PRIORITY", PRIORITYCOUNT, null, null, null, YEAR, MONTH);
                await statModel.addStat(getCluster(HOSP_CODE), HOSP_CODE, METRICS, "CATNORMAL", CATNORMALCOUNT, null, null, null, YEAR, MONTH);
                await statModel.addStat(getCluster(HOSP_CODE), HOSP_CODE, METRICS, "CATPRIORITY", CATPRIORITYCOUNT, null, null, null, YEAR, MONTH);
                break;
              case 'HA_CHAT_DETAIL':
